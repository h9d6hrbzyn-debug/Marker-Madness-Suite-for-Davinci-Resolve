...
<!-- Banked copy of ByteDance's official Seedance 2.5 prompt-optimization skill (v0.1.1),
     captured 2026-08-15 from the npx `skills` install (source:
     https://arkdocs-en.tos-ap-southeast-1.volces.com/skills/ — blocked from cloud sessions).
